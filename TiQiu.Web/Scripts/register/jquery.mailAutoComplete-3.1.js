...
(function($){
	$.fn.mailAutoComplete = function(options){
		var defaults = {
			...
			mailArr: ["qq.com","139.com","163.com","126.com","sina.com","hotmail.com","yahoo.cn","sohu.com"], //邮件数组
		...
		$(this).each(function(){
			...
			var w = that.outerWidth(), h = that.outerHeight() < 1 ? 28 : that.outerHeight(); //获取当前对象（即文本框）的宽高。20130522 FF下iframe内部获取元素高度bug修改
			//样式的初始化
			that.wrap('<span style="display:inline-block;position:relative;_display:inline;"></span>')
