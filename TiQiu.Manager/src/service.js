angular.module('tiqiu')
    .factory('Auth', function ($http, $q) {
        ...
        return {
            login: function (user) {
                ...
                $http({
                    url: domain + '/Accounthandler.ashx',
                    method: "GET",
                    params: {
                        action: 'LoginB',
                        name: user.username,
    ...
    .factory('Message', function ($http, Auth, $q) {
        return {
            getMessage: function () {
                var user = Auth.getCurrentUser() || {};
                var deferred = $q.defer();
                ...
                if (!user.Token) {
                    ...
                    $http({
                        url: domain + '/messagehandler.ashx',
                        method: "GET",
                        params: {
    ...
    .factory('Order', function ($http, Auth, $q) {
        return {
            getOrderRequestList: function (pageindex, pagesize) {
                var user = Auth.getCurrentUser() || {};
                var deferred = $q.defer();
