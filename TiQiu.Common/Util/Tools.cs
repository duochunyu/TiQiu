...
namespace TiQiu.Common.Util
{
    public static class Tools
    {
       ...
       {
           return Regex.IsMatch(source, @"^(13[0-9]|15[012356789]|17[0-9]|18[0-9]|14[57])[0-9]{8}$", RegexOptions.IgnoreCase);
       }
     ...
     public static bool IsIDCard18(string Id)
        ...
        *  ********/
        ...
        {
            return BuildRndCodeOnly(sNumber, length);
        }
        //获取优惠券代码。
        public static string getPromotionCode()
        {
            return getPromotionCode(10);//默认长度为10
        }
        public static string getPromotionCode(int codeLength)
        {
            if (codeLength < 6 || codeLength > 20)
            {
                throw new Exception("优惠券的长度必须大于5且小于等于20");
            }
            string strTmp = "234679ACDEFGHJKLMNPQRTUVWXYZ";
            return BuildRndCodeOnly(strTmp, codeLength);
        }
